...
export default function InboxPage() {
  ...
  return (
    <div style={{ display: 'flex', height: 'calc(100vh / 1.1 - 68px)', overflow: 'hidden' }}>
      {/* Chat List */}
      <div style={{ width: '340px', borderRight: '2px solid rgba(74, 222, 128, 0.8)', boxShadow: '2px 0 12px rgba(74, 222, 128, 0.2)', background: 'white', display: 'flex', flexDirection: 'column', flexShrink: 0, zIndex: 10 }}>
        <div style={{ padding: '20px 16px 12px', borderBottom: '2px solid rgba(74, 222, 128, 0.8)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: '#F4F6F8' }}>
        {!selectedConvId ? (
          ...
          <>
            <div style={{ background: 'white', padding: '14px 20px', borderBottom: '2px solid rgba(74, 222, 128, 0.8)', boxShadow: '0 2px 10px rgba(74, 222, 128, 0.1)', display: 'flex', alignItems: 'center', gap: '12px', zIndex: 5 }}>
              {selectedConv && (<>
            ...
            <div style={{ background: 'white', borderTop: '2px solid rgba(74, 222, 128, 0.8)', boxShadow: '0 -2px 10px rgba(74, 222, 128, 0.1)', padding: '12px 16px', zIndex: 5 }}>
